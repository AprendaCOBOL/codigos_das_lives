      ...
      * Author: ANDRE COSTA
      * Date: 21/04/2021
      * Purpose: MOSTRAR BALANCELINE DE INTERCESSÃO
      ******************************************************************
      ...
      ****************  ARQUIVO DE RESULTADO DO BALANCELINE ***********
                ...
                'C:\CursoCOBOL\COBOL\01 - Basico\bin\CONTATOR.DAT'
                ORGANISATION IS INDEXED
      ...
      ********* ABERTURA DO ARQUIVO DE RESULTADO PARA GRAVAÇÃO ********
       ...
       P900-FINALIZA.
            ...
            DISPLAY '************************************************'
            DISPLAY '*      RESULTADO DO BALANCELINE - INTERCESSAO   '
            DISPLAY '************************************************'
            DISPLAY  ' '
